...
public class About extends JFrame
{
	 ...
	 public About() 
	 {
	        ...
	        JLabel heading = new JLabel("<html>CRUD Operation<br/>Management System</html>");
	        heading.setBounds(70, 20, 300, 130);
	        heading.setFont(new Font("Tahoma", Font.BOLD, 30));
	        add(heading);
	        
	        JLabel name = new JLabel("Developed By: Tech Titans ");
	        name.setBounds(70, 220, 550, 40);
	        name.setFont(new Font("Tahoma", Font.BOLD, 30));
	        add(name);
	        
	        JLabel rollno = new JLabel("Roll number: 201025");
